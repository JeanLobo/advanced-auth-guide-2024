    ...
    <div className="grid min-h-svh lg:grid-cols-2">
      ...
      <div className="relative hidden bg-zinc-900 lg:block">
        ...
        <div className="absolute bottom-10 left-10 right-10 text-white z-20">
          <h2 className="mb-4 text-3xl font-bold">Crie sua conta agora</h2>
          <p className="text-lg font-light">Tenha acesso a todas as ferramentas de gestão em poucos passos.</p>
        </div>
      </div>
    </div>
  );
